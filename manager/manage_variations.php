...
<div class="dashboard-layout">
    ...
    <div class="dashboard-main fade-in-up">
        <header style="margin-bottom: 40px;">
            <div style="font-size: 14px; color: var(--colors-muted); text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 4px; font-weight: 600;">Inventory Control</div>
        ...
        <div class="dashboard-split" style="gap: 32px;">
            <div class="surface-card" style="margin-bottom: 0; padding: 32px; border: 1px solid var(--colors-hairline);">
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            <th style="background: var(--colors-surface-soft);">Size</th>
                            <th style="background: var(--colors-surface-soft);">Color</th>
                            <th style="background: var(--colors-surface-soft);">Stock</th>
                            <th style="background: var(--colors-surface-soft); text-align: right;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($variations_list as $v): ?>
                            <tr>
                                <td style="font-weight: 600;"><?php echo htmlspecialchars($v['size']); ?></td>
                                ...
                                <td>
                                    <form method="POST" style="display: flex; gap: 8px; align-items: center; margin: 0;">
                                        ...
                                        <input type="number" name="new_stock" value="<?php echo $v['stock_quantity']; ?>" 
                                               style="width: 80px; padding: 4px 8px; font-size: 13px; font-family: var(--typography-code-font); font-weight: 700; color: var(--colors-accent-coral); border: 1px solid var(--colors-hairline-soft);">
                                        <button type="submit" name="update_stock" class="button-secondary" style="padding: 4px 8px; font-size: 11px;">Quick Commit</button>
                                    </form>
                                </td>
                                <td style="text-align: right;">
                                    <a href="delete_variation.php?id=<?php echo $v['id']; ?>&product_id=<?php echo $product_id; ?>" style="color: var(--colors-error); font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Remove</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <div style="margin-top: 32px;">
                    <a href="products_list.php" class="button-secondary" style="font-size: 13px; padding: 10px 20px;">← Back to Collection</a>
                </div>
            </div>

            <div class="surface-card" style="margin-bottom: 0; height: fit-content; padding: 32px; border: 1px solid var(--colors-hairline);">
                ...
                <form method="POST">
                    <div class="form-group">
                        <label class="form-label">Size Architecture</label>
                    ...
                    <div class="form-group">
                        <label class="form-label">Color Narrative</label>
                        <input type="text" name="color" placeholder="e.g. Midnight Black, Ivory White" required class="form-input">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Initial Stock</label>
                        <input type="number" name="stock" value="0" required class="form-input">
                    </div>
                    <button type="submit" name="add_variation" class="button-primary" style="width: 100%; margin-top: 12px;">Commit Variation</button>
                </form>
            </div>
        </div>
    </div>
