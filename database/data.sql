...
INSERT INTO `users` VALUES (6,'ali','ali@example.com','$2y$10$W1tv6uVIGgGjGSqsCUi0n.IF1W3Q2Ep/qikAOT2td0YQZL/.apDR2','buyer','Ali','123, Jalan ABC, Puchong, 12122, Malaysia',NULL,1,NULL,NULL,'2026-06-27 14:23:17'), (7,'lee','lee@example.com','$2y$10$W1tv6uVIGgGjGSqsCUi0n.IF1W3Q2Ep/qikAOT2td0YQZL/.apDR2','buyer','Lee','88, Jalan Mata, Cyberjaya, 53431, Malaysia',NULL,1,NULL,NULL,'2026-06-27 08:23:17'), (8,'mary','mary@example.com','$2y$10$W1tv6uVIGgGjGSqsCUi0n.IF1W3Q2Ep/qikAOT2td0YQZL/.apDR2','buyer','Mary','23, Jalan Utama, Petaling Jaya, 12355, Malaysia',NULL,1,NULL,NULL,'2026-06-27 08:23:17');
INSERT INTO `users` VALUES (9,'john','john@example.com','$2y$10$W1tv6uVIGgGjGSqsCUi0n.IF1W3Q2Ep/qikAOT2td0YQZL/.apDR2','buyer','John',NULL,NULL,1,NULL,NULL,'2026-06-27 14:23:17'), (10,'kylo','kylo@example.com','$2y$10$W1tv6uVIGgGjGSqsCUi0n.IF1W3Q2Ep/qikAOT2td0YQZL/.apDR2','buyer','Kylo',NULL,NULL,1,NULL,NULL,'2026-06-27 08:23:17'), (11,'berry','berry@example.com','$2y$10$W1tv6uVIGgGjGSqsCUi0n.IF1W3Q2Ep/qikAOT2td0YQZL/.apDR2','buyer','Berry',NULL,NULL,1,NULL,NULL,'2026-06-27 08:23:17');
...
INSERT INTO `vouchers` VALUES (3,'REV-B5018F05','Product Review Rewards','percentage',10.00,0.00,'2026-07-28',NULL,1,0,1,6,'specific',6,NULL,'2026-06-28 09:37:06');
INSERT INTO `vouchers` VALUES (64,'REV-68154781','Product Review Rewards','percentage',10.00,0.00,'2026-07-28',NULL,1,0,1,8,'specific',8,NULL,'2026-06-28 10:56:22');
INSERT INTO `vouchers` VALUES (65,'REV-B068FFD8','Product Review Rewards','percentage',10.00,0.00,'2026-07-28',NULL,1,0,1,8,'specific',8,NULL,'2026-06-28 10:56:40');
...
INSERT INTO fashion_store.cart (user_id,variation_id,quantity,created_at) VALUES
     ...
     (7,195,2,'2026-06-28 10:36:32'),
     (8,213,1,'2026-06-28 10:45:05'),
     (8,212,1,'2026-06-28 10:46:41');

INSERT INTO fashion_store.enquiries (user_id,subject,message,response,status,created_at) VALUES
	 (6,'Voucher Issue','How to use the voucher?',NULL,'closed','2026-06-28 09:39:36'),
     (6,'Pants Size','How to use the voucher?',NULL,'open','2026-06-28 10:40:52');
...
Available vouchers appear during checkout and can be applied before placing an order.','2026-06-28 09:44:34'),
    (3,6,'Is there are size for Kids Pants ?','2026-06-28 10:40:52');
...
INSERT INTO fashion_store.orders (id,user_id,voucher_id,total_amount,status,address,completed_at,stock_restored,created_at) VALUES
    ...
    (17,8,2,205,'completed','Mary, 23, Jalan Utama, Petaling Jaya, 12355, Malaysia','2026-06-28 09:36:19',0,'2026-06-28 10:39:17'),
    (18,8,NULL,130,'completed','Mary, Jalan Utama, Petaling Jaya, 12355, Malaysia','2026-06-28 09:36:19',0,'2026-06-28 10:39:32'),
    (19,7,NULL,99.99,'completed','Lee, 88, Jalan Mata, Cyberjaya, 53431, Malaysia','2026-06-28 09:36:19',0,'2026-06-28 10:40:26'),
    (20,6,3,117,'completed','Ali, 123, Jalan ABC, Puchong, 12122, Malaysia','2026-06-28 09:36:19',0,'2026-06-28 10:44:33'),
    (21,6,NULL,99.99,'completed','Ali, Jalan ABC, Puchong, 12122, Malaysia','2026-06-28 09:36:19',0,'2026-06-28 10:44:33');
...
INSERT INTO fashion_store.reviews (user_id,product_id,order_id,rating,comment,admin_reply,created_at) VALUES
     ...
     (8,3,18,5,'Great quality for the price. Fits perfectly and is comfortable enough for everyday wear.',NULL,'2026-06-28 10:56:22'),
     (8,6,18,4,'Fits perfectly and has just the right amount of stretch.',NULL,'2026-06-28 10:56:40');

INSERT INTO fashion_store.voucher_redemptions (voucher_id,user_id,order_id,redeemed_at) VALUES
	 (2,6,16,'2026-06-28 09:35:56'),
     (2,8,17,'2026-06-28 10:34:48'),
     (3,6,20,'2026-06-28 10:37:36');
